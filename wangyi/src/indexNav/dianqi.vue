<template lang="html">
  <div id="dianqi">
    <main>
      ...
      <div class="banner"><img src="http://yanxuan.nosdn.127.net/bbefee4e6b7d9a0e399a47df52eeb9e1.jpg?quality=85&thumbnail=750x0&imageView" alt=""></div>
...
export default {
  ...
  created() {
    this.axios.get('../static/data/dianqi.json').then((res) => {
      // console.log(res);
