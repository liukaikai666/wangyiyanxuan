<template lang="html">
  <div id="fuzhuang">
    <main>
      ...
      <div class="banner"><img src="http://yanxuan.nosdn.127.net/3106963297d35317f633c72d263ec078.jpg?quality=85&thumbnail=750x0&imageView" alt=""></div>
...
export default {
  ...
  created() {
    this.axios.get('../static/data/fuzhuang.json').then((res) => {
      // console.log(res);
      this.result = res.data.data.cateList;
      // console.log(res.data.data.cateList[0].name);
    });
  },
    methods:{
    add(pro){
