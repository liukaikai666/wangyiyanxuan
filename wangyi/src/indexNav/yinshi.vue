<template lang="html">
  <div id="yinshi">
    <main>
      ...
      <div class="banner"><img src="http://yanxuan.nosdn.127.net/0f999828aae4300096f678b2f1279151.jpg?quality=85&thumbnail=750x0&imageView" alt=""></div>
...
export default {
  ...
  created() {
    this.axios.get('../static/data/xihu.json').then((res) => {
      // console.log(res);
