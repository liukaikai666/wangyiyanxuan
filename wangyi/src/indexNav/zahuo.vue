<template lang="html">
  <div id="zahuo">
    <main>
      ...
      <div class="banner"><img src="http://yanxuan.nosdn.127.net/2bee8d5394056172aa0d6cd0c87387d0.jpg?quality=85&thumbnail=750x0&imageView" alt=""></div>
...
export default {
 data(){
  ...
  created() {
    this.axios.get('../static/data/canchu.json').then((res) => {
      // console.log(res);
